    ...
    return (
        <div className='w-[100%]  '>
            <div className='  h-[200px] bg-[#455a64]'>
                <div className=' md:w-[70%] sm:w-[100%]  md:mx-auto   sm:text-center text-center md:text-left'>
            ...
            <div className='bg-[#3d5059] flex flex-col items-center justify-center h-[150px] text-center'>
